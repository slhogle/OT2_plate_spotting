...
- Some kind of reservoir for M9 dilutant (e.g., axygen_1_reservoir_90ml)
...
- [Opentrons P20 8 Channel Electronic Pipette (GEN2)](https://shop.opentrons.com/8-channel-electronic-pipette/). This should be fixed on the
  **LEFT** pipette mount.
- [Opentrons OT-2 96 Tip Rack - 20 µL](https://shop.opentrons.com/opentrons-20-l-tips-160-racks-800-refills/)
- [Opentrons P300 8 Channel Electronic Pipette (GEN2)](https://shop.opentrons.com/8-channel-electronic-pipette/). This should be fixed on the
  **RIGHT** pipette mount.
...
2. The only work that needs to be done outside of the OT-2 is to load 100 µL of your samples into
   columns 1 and 12 of a 96 well plate inside of a biosafety cabinet. 
3. Next these 96-well plates should be loaded on the OT-2 deck into positions 4, 5, 6, 10 , and 11
...
4. [Import](https://support.opentrons.com/s/article/Get-started-Import-a-protocol) and
   ...
   Currently, the protocol is set to add 90 µL to columns 2-7, 9, and 11 and 50 µL to columns 8 and
   10, which produces the dilution series below. Importantly, columns 8 and 10 are a **2-fold**
   ...
   dilutions in the series to use.
...
2. [Import](https://support.opentrons.com/s/article/Get-started-Import-a-protocol) and
   ...
   for the rectangular trays with agar. Most important is to set the "z" offset so that the OT-2
